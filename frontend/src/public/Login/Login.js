                            ...
                            <form action="" className="mt-4" onSubmit={onSubmit}>
                                <div className="form-group mb-4">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input type="email" className="form-control" placeholder="example@mail.com" id="email" autofocus required onChange={onChangeLogin} />
                                    </div>
                                </div>
                                <div className="form-group">
                                    <div className="form-group mb-4">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="password" placeholder="Password" className="form-control" id="password" required onChange={onChangeLogin}/>
                                        </div>
                                    </div>
                                    <div className="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div><Link href="/forgot-password.html" className="small text-right">Lost password?</Link></div>
                                    </div>
                                </div>
